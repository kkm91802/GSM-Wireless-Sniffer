...
class GSMSniffer(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "GSMSniffer")
        ...
        self._rf_gain_range = qtgui.Range(0, 50, 5, 10, 200)
        ...
        self._freq_range = qtgui.Range(90e6, 950e6, 200e3, 100e6, 200)
...
def main(top_block_cls=GSMSniffer, options=None):
